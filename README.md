# integrated_system — DER Telemetry + Dispatch MVP
...
- **Cutsheet (product positioning):** `docs/06_CUTSHEET.md`
- **Current architecture:** `docs/01_ARCHITECTURE_CURRENT.md`
- **Capability matrix:** `docs/02_CAPABILITY_MATRIX.md`
- **Roadmap (V1 → pilots → SaaS trajectory):** `docs/03_ROADMAP_V1.md`
- **Gateway mode design note (RFC):** `docs/04_RFC_EDGE_GATEWAY_MODE.md`
- **Gateway mode test plan:** `docs/05_TEST_PLAN_GATEWAY_MODE.md`
- **Minimal pilot telemetry spec (Wind + PV + events):** `docs/07_TELEMETRY_MINIMAL_PILOT.md`
...
- Telemetry durability and event/alarming support are planned V1 items; see `docs/03_ROADMAP_V1.md` and `docs/07_TELEMETRY_MINIMAL_PILOT.md`.
